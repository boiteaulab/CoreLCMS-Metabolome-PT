...
def assign_formula(timestart,interval,parser,refmasslist,data_dir,file):
	...
	mass_spectrum.molecular_search_settings.max_dbe = 18
	...
	mass_spectrum.molecular_search_settings.min_hc_filter=0.5
...
if __name__ == '__main__':
	...
	global refmasslist
	#refmasslist = '20221101_LBA_Boiteau_Zorbax3p5_AZTDpooled_T14_40_calibrants.ref'
	refmasslist = 'siloxanes_pos.ref'
	...
	flist= ['20221101_LBA_Boiteau_Zorbax3p5_EDTApooled_T16_35.raw']
	os.chdir(data_dir)
	

	for f in flist:
		run_assignment(time_min,time_max,interval,data_dir,f,refmasslist)
